...
*1. Pre-processing tools:* This package has functions which take an `sf`
spatial object and generate a contiguity structure in the form which is
...
*2. Fit the model:* The model can then be fit as normal within `mgcv` or
`brms`.
