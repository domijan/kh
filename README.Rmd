...
1.  This package has *pre-processing tools* which take an `sf` spatial object and generate a contiguity structure in the form which is required by the modelling package.
...
3.  The *post-processing tools* then extract the results of the model into a tidy `sf` format so they can easily be mapped.
